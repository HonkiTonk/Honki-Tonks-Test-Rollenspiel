package body StandardAuswahl is
   ...
   function StandardAuswahl return Integer is
   begin
      ...
      if Text = "beenden" or Text = "ende" then
         ...
         return 0;
      elsif Text = "start" or Text = "starten" or Text = "starte" then
         return 1;
         ...
         return 4;
      elsif Text = "m" or Text = "männlich" or Text = "mann" then
         return 5;
      elsif Text = "w" or Text = "weiblich" or Text = "frau" then
         return 6;
      elsif Text = "1337" then
         return 1337;
      else
         Falsch.Falsch;
         return -10;
