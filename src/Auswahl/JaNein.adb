package body JaNein is
   ...
   function JaNein return Integer is
   begin

      Text := EinWort.EinWort;

      if Text = "j" or Text = "ja" or Text = "ok" then
         return 5;
      elsif Text = "n" or Text = "nein" or Text = "nö" then
         return 6;
   ...
   function JaNeinEinfach return Boolean is
   begin
