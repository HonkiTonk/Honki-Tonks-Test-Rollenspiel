package body Wegwerfen is
   ...
   procedure Text (Auswahl : in Integer) is
   begin
      ...
      case Auswahl is
         ...
         when others =>
            Put_Line ("Sollte niemals aufgerufen werden, Wegwerfen.Text.");
   ...
   procedure WegwerfenSonstiges is
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.SonstigesGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
               Anzahl := MengenAngabe.Anzahl (1);
               Anzahl2 := Anzahl;
               if Anzahl >= Charaktere.Hauptcharakter.Inventar (A).Menge and Anzahl /= 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Charaktere.Hauptcharakter.Inventar (A).ID = IDIntern then
               if Anzahl > Charaktere.Hauptcharakter.Inventar (A).Menge then
                  Prüfung := False;
                  return;
               elsif Anzahl = Charaktere.Hauptcharakter.Inventar (A).Menge then
                  Charaktere.Hauptcharakter.Inventar (A).ID := Gegenstanddatenbank.SonstigesGegenstandListe'First;
                  Charaktere.Hauptcharakter.Inventar (A).Menge := 0;
                  Prüfung := True;
                  SortierenInventar.SortierenInventar;
   ...
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.HeilGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
               Anzahl := MengenAngabe.Anzahl (1);
               Anzahl2 := Anzahl;
               if Anzahl >= Charaktere.Hauptcharakter.Inventar (A).Menge and Anzahl /= 0 then
                  Anzahl2 := Anzahl2 - (Anzahl - Charaktere.Hauptcharakter.Inventar (A).Menge);
   ...
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.WaffenGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
   ...
   procedure WegwerfenRüstungen is
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.RüstungenGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
   ...
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.KampfGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
               Anzahl := MengenAngabe.Anzahl (1);
               Anzahl2 := Anzahl;
               if Anzahl >= Charaktere.Hauptcharakter.Inventar (A).Menge and Anzahl /= 0 then
                  Anzahl2 := Anzahl2 - (Anzahl - Charaktere.Hauptcharakter.Inventar (A).Menge);
   ...
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.HelmGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
   ...
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.HandGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
   ...
   begin
      ...
      if IDIntern = 0 then
         ...
         for A in Charaktere.Hauptcharakter.Inventar'Range loop
            ...
            if Translate (Gegenstanddatenbank.SchuhGegenstandListe (Charaktere.Hauptcharakter.Inventar (A).ID).Name, Ada.Strings.Wide_Maps.Wide_Constants.Lower_Case_Map) = GegenstandName then
   ...
   function WegwerfenAutomatisch (ID, Menge : in Integer) return Boolean is
   begin
      ...
      case ID is
         ...
         when others =>
            Put_Line ("Sollte niemals aufgerufen werden Wegwerfen.WegwerfenAutomatisch.");
            return False;
