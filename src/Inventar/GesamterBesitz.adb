...
package body GesamterBesitz is
   ...
   is begin
      ...
      for A in Charaktere.Hauptcharakter.Inventar'Range loop
         ...
         case
           Charaktere.Hauptcharakter.Inventar (A).ID
         is
            when 0 =>
            ...
            when Gegenstanddatenbank.SonstigesGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.SonstigesGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.SonstigesGegenstandListe (B).ID
                  then
                     Put_Line (Integer'Wide_Image (A) & ". Platz: " & To_Wide_String (Gegenstanddatenbank.SonstigesGegenstandListe (B).Name) & "     Menge:" &
                                 Integer'Wide_Image (Charaktere.Hauptcharakter.Inventar (A).Menge));
            ...
            when Gegenstanddatenbank.HeilGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.HeilGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.HeilGegenstandListe (B).ID
                  then
            ...
            when Gegenstanddatenbank.WaffenGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.WaffenGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.WaffenGegenstandListe (B).ID
                  then
                     Put_Line (Integer'Wide_Image (A) & ". Platz: " & To_Wide_String (Gegenstanddatenbank.WaffenGegenstandListe (B).Name) & "     Menge:"
                               & Integer'Wide_Image (Charaktere.Hauptcharakter.Inventar (A).Menge));
            ...
            when Gegenstanddatenbank.RüstungenGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.RüstungenGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.RüstungenGegenstandListe (B).ID
                  then
                     Put_Line (Integer'Wide_Image (A) & ". Platz: " & To_Wide_String (Gegenstanddatenbank.RüstungenGegenstandListe (B).Name) & "     Menge:"
                               & Integer'Wide_Image (Charaktere.Hauptcharakter.Inventar (A).Menge));
            ...
            when Gegenstanddatenbank.QuestGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.QuestGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.QuestGegenstandListe (B).ID
                  then
            ...
            when Gegenstanddatenbank.KampfGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.KampfGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.KampfGegenstandListe (B).ID
                  then
            ...
            when Gegenstanddatenbank.HelmGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.HelmGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.HelmGegenstandListe (B).ID
                  then
            ...
            when Gegenstanddatenbank.HandGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.HandGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.HandGegenstandListe (B).ID
                  then
            ...
            when Gegenstanddatenbank.SchuhGegenstandListe'Range =>
               ...
               for B in Gegenstanddatenbank.SchuhGegenstandListe'Range loop
                  ...
                  if
                    Charaktere.Hauptcharakter.Inventar (A).ID = Gegenstanddatenbank.SchuhGegenstandListe (B).ID
                  then
