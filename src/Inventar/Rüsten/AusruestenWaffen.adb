package body AusruestenWaffen is
   ...
   procedure AusrüstenWaffen (IDPosition : in Integer) is
   begin
      
      if Gegenstanddatenbank.WaffenGegenstandListe (Charaktere.Hauptcharakter.Inventar (IDPosition).ID).Hand = 2 then
         if Charaktere.Hauptcharakter.WaffenAusgerüstet (1) = 0 and Charaktere.Hauptcharakter.WaffenAusgerüstet (2) = 0 then
         ...
         elsif Charaktere.Hauptcharakter.WaffenAusgerüstet (1) = 0 and Charaktere.Hauptcharakter.WaffenAusgerüstet (2) /= 0 then
         ...
         elsif Gegenstanddatenbank.WaffenGegenstandListe (Charaktere.Hauptcharakter.WaffenAusgerüstet (1)).Hand = 2 then
            ZwischenspeicherID1 := Charaktere.Hauptcharakter.WaffenAusgerüstet (1);
            Charaktere.Hauptcharakter.WaffenAusgerüstet (1) := Charaktere.Hauptcharakter.Inventar (IDPosition).ID;
            Charaktere.Hauptcharakter.WaffenAusgerüstet (2) := Charaktere.Hauptcharakter.Inventar (IDPosition).ID;
            Charaktere.Hauptcharakter.Inventar (IDPosition).ID := ZwischenspeicherID1;
            ...
            FreierPlatz := 0;
            AusrüstenSchleife:
            while AusrüstenLäuft = True loop
               FreierPlatzSchleife:
               for B in Charaktere.Hauptcharakter.Inventar'Range loop
                  if Charaktere.Hauptcharakter.Inventar (B).ID = 0 then
                     FreierPlatz := B;
               ...
               case FreierPlatz is
                  when 0 =>
                     ...
                     if Auswahl = "inventar" then
                        Wegwerfen.Aufteilung;
                     elsif Auswahl = "ausgerüstet" then
                        Wegwerfen.Aufteilung;
                     elsif Auswahl = "beliebige andere eingabe um nichts wegzuwerfen" then
         ...
         if Charaktere.Hauptcharakter.WaffenAusgerüstet (2) = 0 then
            Charaktere.Hauptcharakter.WaffenAusgerüstet (2) := Charaktere.Hauptcharakter.Inventar (IDPosition).ID;
            Charaktere.Hauptcharakter.Inventar (IDPosition).ID := 0;
            SortierenInventar.SortierenInventar;
            return;
            
         elsif Charaktere.Hauptcharakter.WaffenAusgerüstet (1) = 0 then
            Charaktere.Hauptcharakter.WaffenAusgerüstet (1) := Charaktere.Hauptcharakter.Inventar (IDPosition).ID;
            Charaktere.Hauptcharakter.Inventar (IDPosition).ID := 0;
            SortierenInventar.SortierenInventar;
            return;
            
         elsif Gegenstanddatenbank.WaffenGegenstandListe (Charaktere.Hauptcharakter.WaffenAusgerüstet (2)).Hand = 2 then
            ZwischenspeicherID1 := Charaktere.Hauptcharakter.WaffenAusgerüstet (2);
            ...
            if Auswahl = "links" then
               ZwischenspeicherID1 := Charaktere.Hauptcharakter.WaffenAusgerüstet (1);
               Charaktere.Hauptcharakter.WaffenAusgerüstet (1) := Charaktere.Hauptcharakter.Inventar (IDPosition).ID;
               Charaktere.Hauptcharakter.Inventar (IDPosition).ID := ZwischenspeicherID1;
               return;
            elsif Auswahl = "rechts" then
               ZwischenspeicherID1 := Charaktere.Hauptcharakter.WaffenAusgerüstet (2);
               Charaktere.Hauptcharakter.WaffenAusgerüstet (2) := Charaktere.Hauptcharakter.Inventar (IDPosition).ID;
               Charaktere.Hauptcharakter.Inventar (IDPosition).ID := ZwischenspeicherID1;
               return;
            elsif Auswahl = "beliebige andere eingabe um keine Waffe auszutauschen" then
               Put_Line ("Und jetzt drücken sie die Anykey-Taste.");
               return;
            else
               Put_Line ("Sie rüsten die Waffe nicht aus.");
