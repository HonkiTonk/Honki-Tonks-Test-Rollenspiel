...
package body Laden is
   ...
   is begin
      ...
      for A in Speichern.SpeicherständeListe'Range loop
         ...
         if
           Speichern.SpeicherständeListe (A) = Namen
           and
             Speichern.SpeicherständeListe (A) /= ""
           and
             Hauptmenü = False
         then
   ...
   is begin   
      ...
      for PositionSchleifenwert in AuswahlArray'Range (1) loop
         Read_A_Single_Block1:
         loop

            exit Read_A_Single_Block1 when PositionSchleifenwert = AuswahlArray'Last (1) and End_Of_Line (Datei);
            ...
            Append (Source => AuswahlArray (1, PositionSchleifenwert),
                    New_Item => Buffer);
      ...
      for PositionSchleifenwert in AuswahlArray'Range (1) loop
         ...
         loop
            ...
            exit Read_A_Single_Block2 when PositionSchleifenwert = AuswahlArray'Last (1) and End_Of_Line (Datei);
            ...
            Append (Source => AuswahlArray (2, PositionSchleifenwert),
                    New_Item => Buffer);
      ...
      for PositionSchleifenwert in AuswahlArray'Range (1) loop
         ...
         loop
            ...
            exit Read_A_Single_Block3 when PositionSchleifenwert = AuswahlArray'Last (1) and End_Of_Line (Datei);
            ...
            Append (Source => AuswahlArray (3, PositionSchleifenwert),
                    New_Item => Buffer);
