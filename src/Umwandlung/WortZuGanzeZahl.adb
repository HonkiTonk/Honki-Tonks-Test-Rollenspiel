package body WortZuGanzeZahl is
   ...
   function WortZuGanzeZahl (EinWortEingabeString : in Unbounded_Wide_String) return Integer is
   begin
      ...
      for StellenZählen in To_Wide_String (EinWortEingabeStringÄnderbar)'Range loop
         if To_Wide_String (EinWortEingabeStringÄnderbar) (StellenZählen) /= ',' then
            null;
         else
      ...
      for A in To_Wide_String (EinWortEingabeStringÄnderbar)'Range loop
         if To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '1' or To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '2' or To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '3' or To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '4' or
           To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '5' or To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '6' or To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '7' or To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '8' or
           To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '9' or To_Wide_String (EinWortEingabeStringÄnderbar) (A) = '0' then
            Prüfung := True;
         else
            return 0;
         end if;
